...
public class Tests {
    public static void main(String[] args) {
        //        testRK();
        for (int i = 2; i <= 6; i++) {
            PhysicsEngine.defaultH = (float) Math.pow(0.1, i);
            System.out.println(PhysicsEngine.defaultH);
            testAnkie();
        }
//        testAnkie();
    ...
    public static void testAnkie() {
        ...
        long totalMS = 0;
        double time = 0.1;
        double exact = 0.195095; //1.35915732
...
//                code = sv.iterate();
//            }
            for (int i = 0; i < time / PhysicsEngine.defaultH; i++) {
                sv.iterate();
            }
